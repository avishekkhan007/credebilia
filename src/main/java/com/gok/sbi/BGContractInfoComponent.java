...
public class BGContractInfoComponent implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		BankGuaranteeManager.BankGuarantee bg = populateSampleBankGuarantee(blkchainUid,blkChainbankGid,blkChainPaymentAdviceNumber,blkChainPaymentAdviceUid,blkChainReferenceNumber,blkChainBrancName,
				blkChainBrancRepresentativeName,blkChainInsuranceDate,blkChainValidityPeriod,blkChainClaimExpiryDate,blkChainValidFrom,blkChainValidTill,
				blkChainCurrency,blkChainAmount,blkChainBenificeryName,blkChainFileHash,blkChainBankEncryptedKey,blkChainEgpEncryptedKey,blkChainVendorEncryptedKey);
		
		quorumService.publishBankGuarantee(bg);
	...
	private BankGuaranteeManager.BankGuarantee populateSampleBankGuarantee(String buid, String bGid, String payAdvNumber, String payAdvUid, String refNumber, String branchNm,
			String branchRepNm, Integer IssueDt, 
			Integer valPeriod, Integer clmExpDt, Integer validFrm, Integer validTl, String curr, 
			Integer amt, String benificeryNm, String fileHsh, String bankEncrKey, String egpEncrKey, String vendrEncrKey) {
